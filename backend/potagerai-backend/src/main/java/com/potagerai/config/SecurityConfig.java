...
import com.potagerai.security.JwtAuthenticationFilter;
 ...
 * Aucune session HTTP créée côté serveur.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Estimation de surface — publique (orientation avant création de compte)
                        .requestMatchers(HttpMethod.GET, "/api/v1/surface-estimate").permitAll()
